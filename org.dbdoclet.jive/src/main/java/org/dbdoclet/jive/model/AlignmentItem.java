 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: AlignmentItem.java,v 1.1.1.1 2004/12/21 13:56:56 mfuchs Exp $
 * Author.....: $Author: mfuchs $
 * Date.......: $Date: 2004/12/21 13:56:56 $
...
public final class AlignmentItem extends LabelItem {
    ...
    public AlignmentItem(String value) {
        ...
        if (value.equalsIgnoreCase("left")) {
            ...
            label = ResourceServices.getString(res,"C_ALIGNMENT_LEFT");
        } else if (value.equalsIgnoreCase("justify")) {

            label = ResourceServices.getString(res,"C_ALIGNMENT_JUSTIFY");
        } else if (value.equalsIgnoreCase("center")) {

            label = ResourceServices.getString(res,"C_ALIGNMENT_CENTER");
        } else if (value.equalsIgnoreCase("right")) {

            label = ResourceServices.getString(res,"C_ALIGNMENT_RIGHT");
        }
...
/*
 * $Log: AlignmentItem.java,v $
 * Revision 1.1.1.1  2004/12/21 13:56:56  mfuchs
 * Reimport
 *
