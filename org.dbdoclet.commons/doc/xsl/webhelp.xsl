<xsl:stylesheet exclude-result-prefixes="#default" version="1.0" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:import href="http://docbook.sourceforge.net/release/xsl/current/webhelp/xsl/webhelp.xsl"/>
  ...
  <xsl:param name="base.dir">./build/webhelp/content/</xsl:param>
  ...
  <xsl:param name="epub.metainf.dir">build/webhelp/META-INF/</xsl:param>
  <xsl:param name="epub.oebps.dir">build/webhelp/OEBPS/</xsl:param>
